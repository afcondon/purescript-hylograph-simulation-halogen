...
var selectChildInheriting = /* #__PURE__ */ PSD3_Internal_Selection_Operations.selectChildInheriting(Effect_Class.monadEffectEffect);
...
var selectChildInheritingD3v2 = function (selector) {
    return function (v) {
        return function __do() {
            var result = selectChildInheriting(selector)(v)();
            return result;
        };
    };
};
...
var attributeValueToString = function (v) {
    ...
    throw new Error("Failed pattern match at PSD3.Interpreter.D3 (line 320, column 1 - line 320, column 51): " + [ v.constructor.name ]);
};
        ...
        return function (v) {
            return function (attrs) {
                var v1 = (function () {
                    ...
                    throw new Error("Failed pattern match at PSD3.Interpreter.D3 (line 159, column 65 - line 160, column 44): " + [ v.constructor.name ]);
                })();
                ...
                return traverseWithIndex_(function (arrayIndex) {
                    return function (v2) {
                        var logicalIndex = (function () {
                            ...
                            throw new Error("Failed pattern match at PSD3.Interpreter.D3 (line 169, column 26 - line 171, column 34): " + [ v1.indices.constructor.name ]);
                        })();
                        return function __do() {
                            ...
                            return traverse_(function (attr) {
                                ...
                                throw new Error("Failed pattern match at PSD3.Interpreter.D3 (line 181, column 34 - line 195, column 20): " + [ attr.constructor.name ]);
                            })(attrs)();
                        };
                    };
                })(paired);
        ...
        return function (v) {
            return function (attrs) {
                var v1 = (function () {
                    ...
                    throw new Error("Failed pattern match at PSD3.Interpreter.D3 (line 199, column 56 - line 200, column 46): " + [ v.constructor.name ]);
                })();
                var paired = Data_Array.zipWith(function (d) {
                    return function (e) {
                        return {
                    ...
                    return function (v2) {
                        return function __do() {
                            ...
                            traverse_(function (attr) {
                                ...
                                throw new Error("Failed pattern match at PSD3.Interpreter.D3 (line 216, column 34 - line 230, column 20): " + [ attr.constructor.name ]);
                            })(attrs)();
            ...
            return function (v) {
                return function (attrs) {
                    var v1 = (function () {
                        ...
                        throw new Error("Failed pattern match at PSD3.Interpreter.D3 (line 237, column 65 - line 238, column 44): " + [ v.constructor.name ]);
                    })();
                    var paired = Data_Array.zipWith(function (d) {
                        return function (e) {
                            return {
                    ...
                    return traverseWithIndex_(function (arrayIndex) {
                        return function (v2) {
                            var logicalIndex = (function () {
                                ...
                                throw new Error("Failed pattern match at PSD3.Interpreter.D3 (line 247, column 26 - line 249, column 34): " + [ v1.indices.constructor.name ]);
                            })();
                            ...
                            return function __do() {
                                ...
                                return traverse_(function (attr) {
                                    ...
                                    throw new Error("Failed pattern match at PSD3.Interpreter.D3 (line 262, column 34 - line 276, column 20): " + [ attr.constructor.name ]);
                                })(attrs)();
                            };
                        };
                    })(paired);
            ...
            return function (v) {
                return function (attrs) {
                    var v1 = (function () {
                        ...
                        throw new Error("Failed pattern match at PSD3.Interpreter.D3 (line 280, column 56 - line 281, column 46): " + [ v.constructor.name ]);
                    })();
                    var paired = Data_Array.zipWith(function (d) {
                        return function (e) {
                            return {
                        ...
                        return function (v2) {
                            ...
                            return function __do() {
                                ...
                                traverse_(function (attr) {
                                    ...
                                    throw new Error("Failed pattern match at PSD3.Interpreter.D3 (line 300, column 34 - line 314, column 20): " + [ attr.constructor.name ]);
                                })(attrs)();
                                return PSD3_Internal_Transition_FFI.transitionRemove_(transition)();
                            };
                        };
