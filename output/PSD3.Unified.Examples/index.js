...
var simpleJoinExample = function (points) {
    ...
    return PSD3_AST.joinData("circles")("circle")(points)(circleTemplate);
};
...
var nestedJoinExample = function (scene) {
    ...
    return PSD3_AST.nestedJoin("points")("circle")([ scene ])(function (v) {
        return v.points;
    })(circleTemplate);
};
...
var joinWithGUPExample = function (points) {
    ...
    return PSD3_AST.updateJoin("circles")("circle")(points)(circleTemplate)({
        enter: new Data_Maybe.Just({
            attrs: [ PSD3_Unified_Attribute.attr("r")(Data_Function["const"](0.0))(PSD3_Unified_Display.showNumD), PSD3_Unified_Attribute.attr("opacity")(Data_Function["const"](0.0))(PSD3_Unified_Display.showNumD) ],
        ...
        exit: new Data_Maybe.Just({
            attrs: [ PSD3_Unified_Attribute.attr("opacity")(Data_Function["const"](0.0))(PSD3_Unified_Display.showNumD) ],
            transition: Data_Maybe.Nothing.value
        }),
...
var fullJoinExample = function (scene) {
    ...
    return PSD3_AST.updateNestedJoin("viz")("circle")([ scene ])(function (v) {
        return v.points;
    })(circleTemplate)({
        enter: new Data_Maybe.Just({
            attrs: [ PSD3_Unified_Attribute.attr("r")(Data_Function["const"](0.0))(PSD3_Unified_Display.showNumD) ],
            transition: Data_Maybe.Nothing.value
        }),
